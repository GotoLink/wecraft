          ...
          if(entity instanceof EntityItem){
        	  ...
        	  if(tileentitychest == null)
        	  {
        		  ...
        		  if(itemstack != null)
        		  {
                    ...
                    /* ItemStack itemstack2 = tileentitychest.getStackInSlot(random.nextInt(tileentitychest.getSizeInventory()));
                    if(itemstack.itemID == itemstack2.itemID || itemstack2 == null)
                    {
                        if(itemstack.stackSize+itemstack2.stackSize <= 64){ 
                        itemstack.stackSize = itemstack.stackSize + itemstack2.stackSize;
                        */
